...
import org.xiaoyu.micro.web.ContextLoaderInitializer;
import org.xiaoyu.micro.web.utils.ClassPathUtils;
...
public class MicroApplication {
    ...
    final Logger logger = LoggerFactory.getLogger(MicroApplication.class);

    public static void run(String webDir, String baseDir, Class<?> configClass, String... args) throws Exception {
        new MicroApplication().start(webDir, baseDir, configClass, args);
    }
