...
import org.xiaoyu.scan.convert.ValueConverterBean;
import org.xiaoyu.scan.destroy.AnnotationDestroyBean;
import org.xiaoyu.scan.destroy.SpecifyDestroyBean;
import org.xiaoyu.scan.init.AnnotationInitBean;
import org.xiaoyu.scan.init.SpecifyInitBean;
...
import org.xiaoyu.scan.proxy.InjectProxyOnConstructorBean;
import org.xiaoyu.scan.proxy.InjectProxyOnPropertyBean;
import org.xiaoyu.scan.proxy.OriginBean;
import org.xiaoyu.scan.proxy.SecondProxyBean;
...
public class AnnotationConfigApplicationContextTest {
    ...
    public void testDestroyMethod() {
        ...
        try (var ctx2 = new AnnotationConfigApplicationContext(ScanApplication.class, createPropertyResolver())){
            bean1 = ctx2.getBean(AnnotationDestroyBean.class);
            bean2 = ctx2.getBean(SpecifyDestroyBean.class);
